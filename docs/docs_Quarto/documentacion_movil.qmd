---
title: "Documentación Técnica - Aplicación Móvil"
subtitle: "Tienda Universitaria UNL"
...
4. **Seguridad:** Los tokens JWT no se exponen directamente en los componentes, se gestionan mediante el wrapper `apiFetch`.
